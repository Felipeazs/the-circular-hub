...
const LayoutAuthUsuarioResultadosIndexRoute = LayoutAuthUsuarioResultadosIndexImport.update({
	id: "/resultados/",
	path: "/resultados/",
	getParentRoute: () => LayoutAuthUsuarioRoute,
} as any)

const LayoutAuthUsuarioResultadosIdRoute = LayoutAuthUsuarioResultadosIdImport.update({
	id: "/resultados/$id",
	path: "/resultados/$id",
	getParentRoute: () => LayoutAuthUsuarioRoute,
} as any)
